...
//
// Coverage:
//   1. Header brand (the literal "Postly" string)
//   2. Empty-state copy (loading / "No posts yet" / "Welcome to Postly!")
...
describe('HomeScreen – empty-state copy', () => {
    ...
    it('returns the "Welcome to Postly!" copy when the viewer follows nobody yet', () => {
    ...
    it('the "Welcome to Postly!" copy is stable and non-empty', () => {
        expect(HOME_EMPTY_NEW_USER_TITLE).toBe('Welcome to Postly!');
