...
import {
  ...
  ShareIcon, PlusIcon, PostlyIcon, VerifiedIcon, FlagIcon,
  ReportIcon, StarIcon,
...
describe('Icons', () => {
  ...
  it('PostlyIcon accepts className prop', () => {
    const el = React.createElement(PostlyIcon, { className: 'w-10 h-10' });
    expect(el.props.className).toBe('w-10 h-10');
  });

  it('PostlyIcon uses default className when none provided', () => {
    const el = React.createElement(PostlyIcon, {});
