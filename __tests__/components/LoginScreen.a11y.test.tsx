...
// ─── 1. Mocks ───────────────────────────────────────────────────────────
// The LoginScreen imports PostlyIcon (SVG) and the Supabase client. We
...
jest.mock('../../components/Icons', () => {
  ...
  const PostlyIcon: React.FC<{ className?: string }> = ({ className }) =>
    React.createElement('span', {
      'data-testid': 'postly-icon',
      className: className || '',
      'aria-hidden': true,
    });
  return { __esModule: true, PostlyIcon };
});
