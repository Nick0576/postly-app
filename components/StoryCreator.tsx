        ...
        <div className="flex flex-col items-center space-y-1 flex-shrink-0">
            ...
            >
                ...
                <div className="w-14 h-14">
                    {hasAnyStory ? (
                         // View when story exists: Blue Postly Icon
                        <PostlyIcon className="w-full h-full text-blue-500" />
                    ) : (
                        // View when no story exists: White Postly Icon
                        <PostlyIcon className="w-full h-full text-white" />
                    )}
                </div>
            </button>
