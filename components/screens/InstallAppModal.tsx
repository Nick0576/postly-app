...
import { XIcon, DownloadIcon, PostlyIcon, ShareIOSIcon, AddToHomeScreenIOSIcon, MoreVertAndroidIcon } from '../Icons';
    ...
    return (
        ...
        >
            ...
            >
                ...
                <PostlyIcon className="w-16 h-16 text-blue-500 mx-auto" />
                
                <h2 id="install-dialog-title" className="text-2xl font-bold text-white mt-4">Get the Postly App</h2>
                
                {installPromptEvent ? (
                    <>
                        <p className="text-gray-300 mt-2">
                            Download the Postly app to your device for a faster, more immersive experience with offline access.
                        </p>
