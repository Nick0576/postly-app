    ...
    return (
        <div className="fixed inset-0 bg-white dark:bg-gray-100 z-[100] flex flex-col h-screen animate-fade-in">
            ...
            <div className="flex-1 overflow-y-auto p-6 text-black prose">
                <h2 className="font-bold">Postly Social &ndash; Privacy Policy</h2>
                <p className="text-sm text-gray-600 mb-6">Last Updated: October 26, 2025</p>

                <p>Welcome to Postly Social ("we," "our," or "us"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and related services (collectively, the "App").</p>
                <p>By using Postly Social, you agree to the collection and use of information in accordance with this policy. This policy is written to comply with the EU General Data Protection Regulation (GDPR), the California Consumer Privacy Act (CCPA), and the Google Play Developer Policy.</p>
