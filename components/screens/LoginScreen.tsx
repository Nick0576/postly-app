    ...
    return (
        <div className="h-screen w-screen bg-black flex flex-col justify-center items-center p-4 font-sans">
            ...
            <div className="w-full max-w-sm text-center animate-fade-in-up">
                <PostlyIcon className="w-24 h-24 mx-auto mb-4 text-blue-500 logo-splash-animation" />
                <h1 className="text-5xl font-bold text-white mb-8 font-handwriting">Postly</h1>
