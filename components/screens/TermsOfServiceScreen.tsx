    ...
    return (
        <div className="fixed inset-0 bg-white dark:bg-gray-100 z-[100] flex flex-col h-screen animate-fade-in">
            ...
            <div className="flex-1 overflow-y-auto p-6 text-black prose">
                <h2 className="font-bold">Postly Social &ndash; Terms of Service</h2>
                <p className="text-sm text-gray-600 mb-6">Last Updated: October 26, 2025</p>

                <p>Welcome to Postly Social ("the App," "we," "our," or "us"). These Terms of Service ("Terms") govern your access to and use of the Postly Social app, website, and related services (collectively, the "Service"). By creating an account or using the Service, you agree to be bound by these Terms.</p>
                ...
                <p>You retain ownership of all content you post, upload, or share on the Service ("User Content"). By submitting User Content, you grant Postly Social a non-exclusive, worldwide, royalty-free, sublicensable, and transferable license to host, display, reproduce, modify (for formatting purposes), distribute, and make available your content in connection with operating and providing the Service.</p>
                ...
                <p>The Service and its original content (excluding User Content), features, and functionality are and will remain the exclusive property of Postly Social and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without our prior written consent.</p>
                ...
                <ul className="list-disc list-inside space-y-1">
                    <li><strong>Email:</strong> <a href="mailto:postlysocialapp@gmail.com" className="text-blue-600 hover:underline">postlysocialapp@gmail.com</a></li>
                </ul>
            </div>
        </div>
    );
