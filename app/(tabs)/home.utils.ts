 ...
 * `DancingScript_700Bold` font but the literal string is just `"Postly"`.
 * Centralising the constant lets the test pin the brand to one place.
 */
export const HOME_HEADER_BRAND = 'Postly' as const;
 ...
 */
export const HOME_EMPTY_NEW_USER_TITLE = 'Welcome to Postly!' as const;
 ...
 *     * `false` → "Welcome to Postly!" onboarding copy
 *
