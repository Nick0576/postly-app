    ...
    <SafeAreaView className="flex-1 bg-black">
      ...
      <ScrollView className="flex-1 px-6 py-6">
        ...
        <Text className="text-gray-300 text-base mb-6 leading-7">
          At Postly, we take your privacy seriously. This policy describes how we collect, use, and share your personal information when you use our mobile application.
        </Text>
        ...
        <Text className="text-gray-500 text-sm mb-6 leading-6">
          Source code available at: github.com/postly-app/postly-social-mobile
        </Text>
