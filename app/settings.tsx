        ...
        <View className="px-6 py-6">
          ...
          <View className="bg-gray-900 rounded-2xl border border-gray-800 overflow-hidden mb-8">
            <Pressable
              ...
              className={`flex-row items-center justify-between px-4 py-4 border-b border-gray-800 ${theme === 'light' ? 'bg-gray-800' : ''}`}
            >
              <Text className="text-white text-base">Light Mode</Text>
              {theme === 'light' && <View className="w-2 h-2 rounded-full bg-blue-500" />}
            </Pressable>
            <Pressable
              onPress={() => setTheme('dark')}
              className={`flex-row items-center justify-between px-4 py-4 border-b border-gray-800 ${theme === 'dark' ? 'bg-gray-800' : ''}`}
            >
              <Text className="text-white text-base">Dark Mode</Text>
              {theme === 'dark' && <View className="w-2 h-2 rounded-full bg-blue-500" />}
            </Pressable>
            <Pressable
              onPress={() => setTheme('system')}
              className={`flex-row items-center justify-between px-4 py-4 ${theme === 'system' ? 'bg-gray-800' : ''}`}
            >
          ...
          <View className="mt-12 items-center">
            <Text className="text-gray-700 text-xs">POSTLY MOBILE v1.0.0</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
